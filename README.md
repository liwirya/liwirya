...
<p align="left">
  ...
  <code>🎓 Electrical Engineering • Information Engineer</code><br>
  <code>🏢 Ex-MSB Mandir • Ex-OBS Foundation • Ex-SIB 7</code><br>
  <code>💻 Full-Stack • Mobile • Automation</code><br>
  <code>⚡ "Code, Coffee, Repeat"</code>
</p>
...
const liwirya = {
    ...
    expertise: {
        ...
        other: ["AI/ML", "IoT", "Automation", "REST API"]
    },
    ...
    currentFocus: "Building scalable apps & exploring AI",
...
console.log("Welcome to my GitHub! Let's build something cool 🚀");
```
...
```plaintext
✅ Software Engineer Lead - Leading tech teams
✅ Full-Stack Developer - Web & Mobile apps
✅ IoT Engineer - Smart automation systems
✅ 100+ commits - Consistent coding habits
✅ Multi-platform - Web, Mobile, IoT, AI
```
...
- 🌙 Lebih produktif malam hari (night owl!)
- ☕ Kopi = bahan bakar utama
- 🎮 Gamer casual di waktu luang
- 📚 Lifelong learner - selalu eksplorasi tech baru
- 🤝 Open untuk kolaborasi project keren
